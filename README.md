...
![architecturePaddock1 drawio](https://github.com/user-attachments/assets/1f5237a9-8ff6-441e-874f-8ed5d3d12087)
...
2.  Run the consumer script:
    ...
    ```
3.  The script will start polling Redis. Let it run for as long as you want to process data.
